...
TIMERS=(tybot-update tybot-collect tybot-tidy tybot-index tybot-schedule-sync tybot-schedule-reconcile tybot-schedule-dm tybot-review-dm tybot-convert-retry tybot-convert-alert)
for u in "${TIMERS[@]}"; do
